...
export const NostrRelayHandler = () => {
  ...
  }, [dispatch, hasContactList, relaysCount])
  ...
  }, [hasContactList, relaysCount, prevRelayCount, hasPerformedInitialFetch, setHasPerformedInitialFetch, dispatch])
  ...
  }, [appVisible, setAppVisible, hasContactList, dispatch])
}
